var _Noveld = function() {
    ...
    //this._options = {em:true, ruby:true, thematicBreak:{border:true, text:'◇◆◇◆'}}
    //this._options = {em:{style:''}, ruby:true, thematicBreak:{border:true, text:'◇◆◇◆'}}
    //this._options = {ruby:true, thematicBreak:{border:true, text:'◇◆◇◆'}}
    this._options = {ruby:true, thematicBreak:{border:true, text:'◇◆◇◆'}}
